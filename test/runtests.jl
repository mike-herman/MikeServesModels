...
# !!! Main.UserApp is configured as an alias for Main.MikeServesModels and you might encounter it in some tests
using Main.MikeServesModels, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "MikeServesModels tests" begin
  @includetests ARGS
end
